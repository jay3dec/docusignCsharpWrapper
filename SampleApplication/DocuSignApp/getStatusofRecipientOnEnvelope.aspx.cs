...
{
    public partial class getStatusofRecipientOnEnvelope : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string response = docusignMethods.GetEnvelopeRecipientStatus("A3A5505351714444B9E34B515DF27D6D", false);
        }
    }
}